...
import { PalabrasServicioService } from './../../../servicios/palabras/palabras-servicio.service';
import { Palabras } from './../../../clases/palabras/palabras';
...
export class AhorcadoComponent implements OnInit {
 ...
 URL_IMAGENES_EXT = ".jpg"   
  ...
  selectedLetter:any;
   constructor(
     ...
     private servicioPalabras: PalabrasServicioService
     ) {
 ...
 switch(this.vidas) {
   ...
   getPalabras() {
     ...
     /*
      this.servicioPalabras.getPost().subscribe((data)=> {
      let words:string = data.toString();
